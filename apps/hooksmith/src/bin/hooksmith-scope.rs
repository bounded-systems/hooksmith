...
fn select_root_names(repo: &Repository, tree: &Tree) -> Result<Vec<ObjectDescriptor>, Box<dyn std::error::Error>> {
...
fn select_by_pattern(repo: &Repository, tree: &Tree, pattern: &str) -> Result<Vec<ObjectDescriptor>, Box<dyn std::error::Error>> {
    // TODO: Implement glob pattern matching
    // For now, just return root names
    select_root_names(repo, tree)
}

fn select_by_depth(repo: &Repository, tree: &Tree, depth: usize) -> Result<Vec<ObjectDescriptor>, Box<dyn std::error::Error>> {
