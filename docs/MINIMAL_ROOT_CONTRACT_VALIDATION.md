...
| **Contracts** | `contracts/`, `agreement.json` | Moved | `.hooksmith/contracts/` |
...
The minimal root contract is defined in `.hooksmith/contracts/object-names@root-minimal.json`:
