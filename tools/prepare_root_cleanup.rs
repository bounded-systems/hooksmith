...
impl FileMover {
    ...
    fn move_reports_and_summaries(&mut self) -> Result<()> {
        ...
        let reports = vec![
            "ALL_PRS_SUMMARY.md", "BINARY_CLEANUP_SUMMARY.md", "BRANCH_MERGE_SUMMARY.md",
            "FINAL_PR_APPROVAL_SUMMARY.md", "FINAL_PR_SUMMARY.md", "FINAL_UPSTREAM_MERGE_SUMMARY.md",
            "GITHUB_ACTIONS_WORKFLOW_SUMMARY.md", "GIT_SCOPE_IMPLEMENTATION_SUMMARY.md",
            "GIT_VIEW_SCOPES.md", "HOOKSMITH_COMPLETE_SUMMARY.md", "MERGE_CONFLICTS_SUMMARY.md",
            "PR_MERGE_SUMMARY.md", "PR_SUMMARY.md", "PUSH_SUMMARY.md",
            "README_2025-08-08.md", "README_DIRCHECK.md",
            "SHELL_TO_RUST_CONVERSION_SUMMARY.md", "SHELL_TO_RUST_MIGRATION_COMPLETE.md",
            "SHELL_TO_RUST_MIGRATION_PROGRESS.md", "SHELL_TO_RUST_MIGRATION_SUMMARY.md",
            "WORKTREE_MIGRATION_COMPLETE.md", "WORKTREE_MIGRATION_SUMMARY.md", "WORKTREE_SYNC_STRATEGY.md"
        ];
    ...
    fn move_worktree_and_ops(&mut self) -> Result<()> {
        ...
        self.mv_if(".worktree-config.jsonc", ".hooksmith/worktrees/config.jsonc")?;
    ...
    fn move_test_files(&mut self) -> Result<()> {
        ...
        let test_files = vec![
            "test-agreement.txt", "test-bad-commit.txt", "test-prepare-msg.txt", "test_files.txt",
            "test-file.rs", "test-validation-hooks.rs", "test_attribute_concerns.rs",
            "test_comprehensive_coverage.rs", "test_sbom.rs", "test-git-proxy.rs", "test.gitattributes"
        ];
