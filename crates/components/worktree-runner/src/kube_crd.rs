...
=======
            ...
            // New enhanced states
            WorktreeState::DirtyMainRecovery => {
                Some(WorktreeAction::RecoverDirtyMain)
            },
            WorktreeState::FeatureExtraction => {
                Some(WorktreeAction::ExtractFeature)
            },
            WorktreeState::StaleBranch => {
                Some(WorktreeAction::MarkStale)
            },
            WorktreeState::OrphanedWorktree => {
                Some(WorktreeAction::CleanupWorktree)
            },
            WorktreeState::NeedsRebase => {
                Some(WorktreeAction::UpdateBranch)
            },
            WorktreeState::NeedsSquash => {
                Some(WorktreeAction::SquashCommits)
            },
            WorktreeState::Approved => {
                None // Wait for merge
            },
...
=======
    serde_yaml::to_string(&WorktreeChangeRequest::crd())
