...
4. [Clean Auto Push Demo](#clean-auto-push-demo)
5. [Codeql Sarif Integration Demo](#codeql-sarif-integration-demo)
6. [Combined Contract Demo](#combined-contract-demo)
7. [Contract State Machine Demo](#contract-state-machine-demo)
8. [Contract Validation Demo](#contract-validation-demo)
9. [Contract Workflow Demo](#contract-workflow-demo)
10. [Filename Contract Demo](#filename-contract-demo)
11. [Generated File Validation Demo](#generated-file-validation-demo)
12. [Git Filter Demo](#git-filter-demo)
13. [Git Lefthook Integration Demo](#git-lefthook-integration-demo)
14. [Git Model Demo](#git-model-demo)
15. [Git Object Contract Demo](#git-object-contract-demo)
16. [Structured Logging Demo](#structured-logging-demo)
17. [Structured Logging Tools Demo](#structured-logging-tools-demo)
18. [Tree Contract Demo](#tree-contract-demo)
19. [Tree Contract Explicit Type Demo](#tree-contract-explicit-type-demo)
20. [Tree Filename Chars Contract Demo](#tree-filename-chars-contract-demo)
21. [Unified Contracts Demo](#unified-contracts-demo)
...
Clean Auto-Push Demo  This example demonstrates the clean auto-push workflow that provides: - Clean, user-friendly output - Porcelain git push output parsing - Comprehensive logging to files - No confusing double push messages  Usage: cargo run -p xtask -- clean-auto-push -m "feat: example commit" cargo run -p xtask -- clean-auto-push --verbose --watchdog --interval 60
...
Git + Lefthook Integration Demo  This example demonstrates how to use the Git + Lefthook integration with event-driven state machine and SARIF integration for contract validation.  ## Features Demonstrated  - **Structured Git Events**: Wrapping git commit/push with JSONL events - **Lefthook Integration**: Capturing and normalizing Lefthook outputs - **State Machine Integration**: Mapping events to state transitions - **SARIF Integration**: Emitting contract violations as SARIF results - **Event Blocking**: Dependency relationships between validation rules
...
- serde_json::Value
- std::collections::HashMap
- hooksmith::git_lefthook_integration::{
