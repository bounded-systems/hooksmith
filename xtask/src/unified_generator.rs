...
impl UnifiedGenerator {
    ...
    pub fn load_registry(&self) -> Result<GeneratedFilesRegistry> {
        ...
        let registry: GeneratedFilesRegistry = serde_json::from_str(&content)
            .with_context(|| format!("Failed to parse registry: {}", self.registry_path.display()))?;
    ...
    pub fn generate_header(&self, content: &str, file_type: &str) -> String {
        ...
        match file_type {
            "md" => format!("<!-- @generated by xtask gen-files --file-type=md -->\n<!-- @checksum: {} -->\n\n", checksum),
            "yml" | "yaml" => format!("# @generated by xtask gen-files --file-type={}\n# @checksum: {}\n\n", file_type, checksum),
            "toml" => format!("# @generated by xtask gen-files --file-type=toml\n# @checksum: {}\n\n", checksum),
            "json" | "jsonc" => format!("// @generated by xtask gen-files --file-type={}\n// @checksum: {}\n\n", file_type, checksum),
            "gitignore" | "gitattributes" => format!("# @generated by xtask gen-files --file-type={}\n# @checksum: {}\n\n", file_type, checksum),
            "CODEOWNERS" => format!("# @generated by xtask gen-files --file-type=CODEOWNERS\n# @checksum: {}\n\n", checksum),
            "wit" => format!("// @generated by xtask gen-files --file-type=wit\n// @checksum: {}\n\n", checksum),
            "makefile" => format!("# @generated by xtask gen-files --file-type=makefile\n# @checksum: {}\n\n", checksum),
            "editorconfig" => format!("# @generated by xtask gen-files --file-type=editorconfig\n# @checksum: {}\n\n", checksum),
            "envrc" => format!("# @generated by xtask gen-files --file-type=envrc\n# @checksum: {}\n\n", checksum),
            _ => format!("# @generated by xtask gen-files --file-type={}\n# @checksum: {}\n\n", file_type, checksum),
        }
    }
